...
8. **N=2 iteration ceiling**: If two rounds of fixes addressing the same critic finding haven't resolved it and a third round on the same surface is appearing, STOP and surface to PJ. This is structural; not a "keep trying" signal.
